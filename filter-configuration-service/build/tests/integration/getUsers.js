...
test.serial("[GET /] returns users as objects without email attribute", async (t) => {
...
test.serial("[GET /:id] returns single user as objects without email attribute", async (t) => {
...
test.serial("[GET /:id] returns 404 if user with given id doesn't exist", async (t) => {
